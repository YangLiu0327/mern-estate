    ...
    <main>
      ...
      {listing && !loading && !error && (
        <div className="mx-auto">
          ...
          <div className="fixed top-[13%] right-[2%] z-10 border rounded-full w-12 h-12 flex justify-center items-center bg-slate-100 cursor-pointer">
            <FaShare
          ...
          {copied && (
            <p className="fixed top-[23%] right-[5%] z-10 rounded-sm bg-slate-100 p-2">
              Link copied!
            </p>
          )}
          <div className="flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4">
            ...
            <div className="flex gap-4">
              <p className="bg-red-900 w-full max-w-[200px] text-white text-center p-1 rounded-md flex-wrap">
